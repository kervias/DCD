import os
from edustudio.datatpl import  EduDataTPL
import json
from atom_op import  M2C_BuildMissingQ, M2C_FillMissingQ, M2C_SplitDataset
...
class DCDDataTPL(EduDataTPL):
    default_cfg = {
        'n_folds': 5,
        'mid2cache_op_seq': [M2C_SplitDataset, 'M2C_GenQMat', M2C_BuildMissingQ, M2C_FillMissingQ],
    ...
    def load_data(cls, cfg):
        ...
        if os.path.exists(fph):
            ...
            raise ValueError("can't find cpt_relation file")
        return kwargs
